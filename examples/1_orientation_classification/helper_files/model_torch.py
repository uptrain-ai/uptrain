...
def get_accuracy_torch(testing_file, model_save_name, model_dir="trained_models_torch/"):
    ...
    with torch.inference_mode():
        ...
        for ele in testing_dataset:
          ...
          X_test, y_test = torch.tensor(X_test).type(torch.float), torch.tensor(y_test).type(torch.float)
