...
def test_a_b_testing():
    ...
    distributions_model_1 = np.array([random_state.normal(*param) for param in params_model_1])
    distributions_model_2 = np.array([random_state.normal(*param) for param in params_model_2])
    ...
    for i in range(size // batch_size):
        ...
        inputs = {
            "data": data,
            "model_name": ["model_1"] * len(data_model_1) + ["model_2"] * len(data_model_2)
        }
        outputs = data
