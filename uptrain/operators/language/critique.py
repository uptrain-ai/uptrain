...
class LanguageCritique(ColumnOp):
    ...
    def evaluate_local(self, data):
        ...
        if self.settings.eval_type == "basic":
            few_shot_examples = CRITIQUE_LANGUAGE_FEW_SHOT__CLASSIFY
            output_format = CRITIQUE_LANGUAGE_OUTPUT_FORMAT__CLASSIFY
            ...
            few_shot_examples = CRITIQUE_LANGUAGE_FEW_SHOT__COT
            output_format = CRITIQUE_LANGUAGE_OUTPUT_FORMAT__COT
        ...
        for idx, row in enumerate(data):
            ...
            try:
                grading_prompt_template = CRITIQUE_LANGUAGE_PROMPT_TEMPLATE.replace(
