...
class DataIntegrity(AbstractAnomaly):
    ...
    def check(self, inputs, outputs, gts=None, extra_args={}):
        signal_value = self.measurable.compute_and_log(inputs, outputs, gts=gts, extra=extra_args)   
        ...
        plot_name = self.measurable.col_name() + " " + self.integrity_type + " " + str(self.threshold)
        self.log_handler.add_scalars(self.dashboard_name + "_" + plot_name, {plot_name: 1 - self.num_issues/self.count}, self.count, self.dashboard_name)
