...
-   **[डेटा बहाव चेक](https://docs.uptrain.ai/docs/uptrain-monitors/data-drift)** - Identify distribution shifts in your model inputs.
...
-   **Model confidence interval**- मॉडल भविष्यवाणियों के लिए विश्वास अंतराल
...
-   **Adversarial Checks**- प्रतिकूल हमलों का मुकाबला करें
...
यह रेपो Apache 2.0 लाइसेंस के तहत प्रकाशित किया गया है। हम वर्तमान में गैर-उद्यम पेशकशों को विकसित करने पर ध्यान केंद्रित कर रहे हैं जो अधिक सुविधाओं को जोड़कर और अधिक मॉडलों को विस्तारित करके अधिकांश उपयोग मामलों को कवर करें। हम एक होस्टेड ऑफरिंग जोड़ने की दिशा में भी काम कर रहे हैं -[संपर्क करें](mailto:sourabh@insane.ai)अगर आपको रुचि हो तो।
...
We are building UpTrain in public. Help us improve by giving your feedback **[यहाँ](https://forms.gle/PXd89D5LiFubro9o9)**.
