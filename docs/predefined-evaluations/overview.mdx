...
|[Response Matching](/predefined-evaluations/ground-truth-comparison/response-matching) | Grades how relevant the generated context was to the question specified. |
  ...
  <Accordion title="Safeguarding Evals">
| Eval | Description |
| ---- | ----------- |
...
| Eval | Description |
| ---- | ----------- |
|[Sub-query Completeness](/predefined-evaluations/sub-query/sub-query-completeness) | Evaluate if the list of generated sub-questions comprehensively cover all aspects of the main question. |
  </Accordion>
