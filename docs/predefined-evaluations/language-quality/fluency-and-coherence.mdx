...
It aims to ensure that the language model not only adheres to guidelines but also communicates its adherence to or deviation from the guideline in an appropriate and respectful manner.
