...
There are four main components in UpTrain:
1. [Operator](/key-components/operator)
2. [Chart](/key-components/chart)
3. [Check](/key-components/check)
4. [CheckSet](/key-components/checkset)
5. [Settings](/key-components/settings)
