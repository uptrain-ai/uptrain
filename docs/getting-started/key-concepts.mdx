---
title: "Key Concepts 🗝️"
description: "Learn what UpTrain can do in practice"
---
...
Uptrain evaluations are specified as `Check` objects. Each `Check` specifies a sequence of tabular 
