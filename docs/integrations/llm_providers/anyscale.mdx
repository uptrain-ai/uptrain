...
ANYSCALE_API_KEY = "esecret_***********************"  # Insert your Anyscale API key here
...
Let's define a dataset to perform evaluation
...
You can also find the complete list of metrics UpTrain supports [here](/predefined-evaluations)
...
Let's look at the evaluations performed by UpTrain
