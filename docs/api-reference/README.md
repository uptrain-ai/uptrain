...
| [Tone Critique](https://github.com/uptrain-ai/uptrain/blob/main/examples/checks/evaluate_tone_critque.ipynb) | Assesses if the tone of machine-generated responses matches with the desired persona. |
