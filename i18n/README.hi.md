...
<h2>
  <p align="center">
    <p align="center">इंजीनियरों के लिए निर्मित ML अनुप्रयोगों का निरीक्षण करने के लिए एक ओपन-सोर्स फ्रेमवर्क</p>
  </p>
</h2>
...
-   **[मॉडल पूर्वाग्रह](https://docs.uptrain.ai/docs/uptrain-monitors/model-bias)** - अपने ML मॉडल की भविष्यवाणियों में पक्षपात को ट्रैक करें।
-   **[AI व्याख्यात्मकता](https://docs.uptrain.ai/docs/uptrain-visuals/shap-explainability)** - भविष्यवाणियों पर कई विशेषताओं के सापेक्ष महत्व को समझें।
...
आप जल्दी से शुरू कर सकते हैं [Google Colab यहाँ](https://colab.research.google.com/drive/1ZIITMB7XYotvhg5CNvGPFnBdM4SR2w4Q?usp=sharing%2F).

इसे अपनी मशीन में चलाने के लिए, नीचे दिए गए चरणों का पालन करें:

### pip के माध्यम से पैकेज स्थापित करें:
...
### AI व्याख्यात्मकता आउट-ऑफ़-द-बॉक्स
...
### UMAP आयाम में कमी और विज़ुअलाइज़ेशन
...
यह रेपो Apache 2.0 लाइसेंस के तहत प्रकाशित किया गया है। हम वर्तमान में गैर-उद्यम पेशकशों को विकसित करने पर ध्यान केंद्रित कर रहे हैं जो अधिक सुविधाओं को जोड़कर और अधिक मॉडलों को विस्तारित करके अधिकांश उपयोग मामलों को कवर करें। हम एक होस्टेड पेशकश को जोड़ने की दिशा में भी काम कर रहे हैं - [संपर्क करें](mailto:tech@uptrain.ai) अगर आपको रुचि हो तो।
